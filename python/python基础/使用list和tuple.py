...
classmates.append('devincob')
print(classmates)
# ['Michael', 'Bob', 'Tracy', 'Adam']
# 也可以把元素插入到指定的位置，比如索引号为1的位置：

classmates.insert(1, 'Jack')
classmates.insert(2,'devin')
print('123',classmates)
# ['Michael', 'Jack', 'devin', 'Bob', 'Tracy', 'Adam', 'devincob']
# 要删除list末尾的元素，用pop()方法：

classmates.pop()
'Adam'
print('456',classmates)
# ['Michael', 'Jack', 'devin', 'Bob', 'Tracy', 'Adam']
# 要删除指定位置的元素，用pop(i)方法，其中i是索引位置：

classmates.pop(2)
'devin'
print('789',classmates)
# ['Michael', 'Bob', 'Tracy']
